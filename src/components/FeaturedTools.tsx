...
import { ExternalLink, Github, Clock, Zap, Terminal, FileText, Eye, Layers } from 'lucide-react';

const tools = [
  {
    name: 'LeetDaily',
    description: 'Track your LeetCode streak. Chrome extension that glows red if you forget to solve.',
    icon: Clock,
    links: [
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Each tool in the Masst ecosystem is built with obsessive attention to detail, 
