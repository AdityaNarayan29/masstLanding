      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10 animate-fade-in">
        <div className="mb-8">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed max-w-2xl mx-auto mb-12">
            Masst is growing into a full SaaS experience for developers — think Notion × Vercel 
            for dev workflows. A unified platform where your tools, documentation, and projects 
            live in harmony.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <div className="text-center">
            ...
            <h3 className="font-semibold text-lg text-foreground mb-2">Unified Workspace</h3>
            <p className="text-muted-foreground text-sm">All your dev tools in one beautiful interface</p>
          </div>
          ...
          <div className="text-center">
            ...
            <h3 className="font-semibold text-lg text-foreground mb-2">Smart Automation</h3>
            <p className="text-muted-foreground text-sm">AI-powered workflows that adapt to your style</p>
          </div>
          ...
          <div className="text-center">
            ...
            <h3 className="font-semibold text-lg text-foreground mb-2">Seamless Integration</h3>
            <p className="text-muted-foreground text-sm">Connect with your existing development stack</p>
          </div>
        </div>
